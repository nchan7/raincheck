...
export class Raincheck extends Component {
    ...
    render() {
        ...
        return (
            ...
            //             <br/>
            //             <hr />
            //             <h1 className="App"> Evening weather route: {props.trip.tripName}</h1>
...
//             <h1 className="App"> Morning weather route:</h1>
// {/* 
//             <div class="starttime" className="App">
//                 <h2>Start Time: {props.trip.startTime}</h2>
//                 <h2> Travel Time: {props.trip.travelTime}</h2>
